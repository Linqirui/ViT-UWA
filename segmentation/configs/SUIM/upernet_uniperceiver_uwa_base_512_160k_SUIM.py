_base_ = [
    '../_base_/models/upernet_r50.py', '../_base_/datasets/SUIM.py',
    '../_base_/default_runtime.py', '../_base_/schedules/schedule_160k.py'
]

pretrained = '../pretrained/uni-perceiver-base-L12-H768-224size-torch-pretrained.pth'
model = dict(
    pretrained=pretrained,
    backbone=dict(
        _delete_=True,
        type='UniPerceiverUWA',
        patch_size=16,
        embed_dim=768,
        depth=12,
        num_heads=12,
        ...
        window_size=[None] * 12),
    decode_head=dict(num_classes=8, in_channels=[768, 768, 768, 768]),
    auxiliary_head=dict(num_classes=8, in_channels=768),
