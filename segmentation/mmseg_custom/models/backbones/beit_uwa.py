...
from .uwa_modules import DetailAwareModule, deform_inputs
from .uwa_modules import VCIMWithCls as VCIM
...
class BEiTUWA(BEiT):
    def __init__(self, pretrain_size=224, conv_inplane=64, n_points=4, deform_num_heads=6,
                 init_values=0., cmlp_ratio=0.25, deform_ratio=1.0, with_cmlp=True,
        ...
        self.dam = DetailAwareModuleAwareModule(inplanes=conv_inplane, embed_dim=embed_dim, with_cp=False)
