...
class ViTUWA(TIMMVisionTransformer):
    def __init__(self, pretrain_size=224, num_heads=12, conv_inplane=64, n_points=4,
                 deform_num_heads=6, init_values=0., interaction_indexes=None, with_cmlp=True,
                 cmlp_ratio=0.25, deform_ratio=1.0, add_vit_feature=True, pretrained=None,
                 use_extra_VCIM_da2=True, with_cp=False, *args, **kwargs):
        ...
        self.dam = DetailAwareModule(inplanes=conv_inplane, embed_dim=embed_dim, with_cp=False)
        self.interactions = nn.Sequential(*[
            VCIM(dim=embed_dim, num_heads=deform_num_heads, n_points=n_points,
                             ...
                             extra_VCIM_da2=((True if i == len(interaction_indexes) - 1
                                               else False) and use_extra_VCIM_da2),
                             with_cp=with_cp)
